...
./Tentacle.exe register-with --instance "Tentacle" --server $SERVER --apiKey $APIKEY --publicHostName=$ipv4 --space $SPACE --role $ROLE --role $ROLE02 --environment $ENVIRONMENT --comms-style TentaclePassive --force --console
