...
elseif ($ENVIRONMENT -eq "07.PRD EU"){
    ...
    ./Tentacle.exe register-with --instance "Tentacle" --server $SERVER --apiKey $APIKEY --name "$NAME-MX" --publicHostName=$ipv4 --space $SPACE --role $array[0] --role "MX" --role $array[5] --environment $ENVIRONMENT --comms-style TentaclePassive --force --console
    ...
    ./Tentacle.exe register-with --instance "Tentacle" --server $SERVER --apiKey $APIKEY --name "$NAME-EU" --publicHostName=$ipv4 --space $SPACE --role $array[2] --role "PT" --role $array[4] --role $array[6] --environment $ENVIRONMENT --comms-style TentaclePassive --force --console
}
